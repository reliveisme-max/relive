        ...
        <div class="col col-12">
            <div class="white-box prod-review-box" id="prod-reviews">
                ...
                <?php $rating_count = $product->get_rating_count();
                    ...
                    <div class="ro-middle">
                        <div class="filter-stars-wrap"><span class="filter-star-item active" data-star="all">Tất
                                cả</span><span class="filter-star-item" data-star="5">5 Sao</span><span
                                class="filter-star-item" data-star="4">4 Sao</span><span class="filter-star-item"
                                data-star="3">3 Sao</span><span class="filter-star-item" data-star="2">2 Sao</span><span
                                class="filter-star-item" data-star="1">1 Sao</span></div>
                    </div>
                    <div class="ro-right"><button type="button" class="btn-write-review" id="btn-open-review"><i
                                class="fas fa-pencil-alt"></i> Gửi đánh giá</button></div>
                </div>
    ...
    <div class="specs-popup-content fpt-popup-style">
        ...
        <div class="sp-body">
            <div class="sp-feature-img"><?php if ($spec_feature_img): ?><img
                    src="<?php echo esc_url($spec_feature_img); ?>" alt="Cấu hình"><?php else: ?><img
                    src="<?php echo esc_url($custom_featured_img ?: wp_get_attachment_image_url($main_image_id, 'full')); ?>"
                    alt="Cấu hình"><?php endif; ?></div>
